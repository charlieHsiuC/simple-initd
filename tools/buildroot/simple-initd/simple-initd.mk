...
define SIMPLE_INITD_INSTALL_TARGET_CMDS
    $(INSTALL) -D -m 0755 $(@D)/target/$(RUSTC_TARGET_NAME)/release/simple-initd $(TARGET_DIR)/bin/simple-initd
    ln -sf /bin/simple-initd $(TARGET_DIR)/sbin/init
    ln -sf /bin/simple-initd $(TARGET_DIR)/sbin/reboot
